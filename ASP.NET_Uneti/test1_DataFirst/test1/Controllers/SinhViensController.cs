...
namespace test1.Controllers
{
    public class SinhViensController : Controller
    {
        ...
        public ActionResult SinhVienDiemKTLTThapNhat()
        {
            var diemmin = db.Diems.Where(d=>d.tenmh.Equals("Kỹ thuật lập trình"))
                .Min(d=>d.diem1);

            var dsmin = db.Diems.Where(d=>d.tenmh.Equals("Kỹ thuật lập trình") && d.diem1 == diemmin)
                .Select(d=>d.SinhVien)
                .ToList();
            return View(dsmin);
        }
