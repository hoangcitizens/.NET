CREATE DATABASE QLTHUVIEN_LAB10
GO
USE QLTHUVIEN_LAB10
--Tạo bảng Tham số
CREATE TABLE [THAMSO](
...
[NgayHetHan] [datetime] NULL,[TienNo] [float] NULL,
...
[MaDocGia] [int] NULL,
[MaNhanVien] [int] NULL,
CONSTRAINT [PK_PHIEUTHUTIEN] PRIMARY KEY
(MaPhieuThuTien))
GO
--Tạo bảng Sách
CREATE TABLE [SACH](
...
[MaDocGia] [int] NULL,
CONSTRAINT [PK_PHIEUMUONSACH] PRIMARY KEY
(MaPhieuMuon))
--Tạo bảng Chi tiết phiếu mượn
CREATE TABLE [CHITIETPHIEUMUON](
[MaSach] [int] NOT NULL,
[MaPhieuMuon] [int] NOT NULL,CONSTRAINT [PK_CHITIETPHIEUMUON] PRIMARY KEY
(MaSach,MaPhieuMuon))
GO
--Tạo khoá ngoại
GO
ALTER TABLE [NHANVIEN] WITH NOCHECK ADD
CONSTRAINT [FK_NHANVIEN_BANGCAP]
...
CONSTRAINT [FK_PHIEUTHUTIEN_DOCGIA]
...
GO
ALTER TABLE [PHIEUTHUTIEN] WITH CHECK ADD
CONSTRAINT [FK_PHIEUTHUTIEN_NHANVIEN] FOREIGN
...
CONSTRAINT [FK_PHIEUMUONSACH_DOCGIA] FOREIGN
KEY([MaDocGia]) REFERENCES [DOCGIA] ([MaDocGia])
...
insert into NHANVIEN values(N'Nguyễn Hữu Hoàng','11/26/2003',N'An Khê Quỳnh Phụ Thái Bình','0905646162',1)
insert into NHANVIEN values(N'Vũ Hồng Anh','05/25/2005',N'An Đồng Hồng Bàng Hải Phòng','0908373612',2)
...
insert into SACH values(N'CÔNG NGHỆ WEB',N'PHẠM ĐÀO MINH VŨ',2009, N'NXB TRẺ', 90000,'12/01/2009')