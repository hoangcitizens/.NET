-- Tạo cơ sở dữ liệu
CREATE DATABASE QuanLySinhVien_LAB11
GO
USE QuanLySinhVien_LAB11
GO
...
CREATE TABLE Login (
    username NVARCHAR(30) PRIMARY KEY, -- Tên đăng nhập, Primary key
    password NVARCHAR(15),             -- Mật khẩu
    fullname NVARCHAR(30),             -- Họ tên
    email NVARCHAR(50),                -- Email
    mobile NVARCHAR(11),               -- Số điện thoại
    sate BIT,                          -- Trạng thái: 1 là hoạt động, 0 là không hoạt động
    mode TINYINT                       -- Phân quyền
);
GO
...
INSERT INTO Login (username, password, fullname, email, mobile, sate, mode)
VALUES 
('hoang', '123456', N'Nguyễn Hữu Hoàng', 'hoang@gmail.com', '0912345678', 1, 3),
('user2', 'password2', N'Trần Thị Bình', 'binh@gmail.com', '0987654321', 1, 2),
('user3', 'password3', N'Lê Văn Cường', 'cuong@gmail.com', '0934567890', 1, 1),
('user4', 'password4', N'Phạm Thị Dịu', 'diu@gmail.com', '0901234567', 1, 1),
('user5', 'password5', N'Hoàng Văn Anh', 'anh@gmail.com', '0911223344', 0, 2);
GO