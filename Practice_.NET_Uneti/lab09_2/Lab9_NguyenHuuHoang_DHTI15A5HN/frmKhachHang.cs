...
namespace Lab9_NguyenHuuHoang_DHTI15A5HN
{
    public partial class frmKhachHang : Form
    {
        ...
        public void loaddl()
        {
            ...
            txt_hoten.DataBindings.Add("Text", dt, "TenKH");
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand
                    ("INSERT INTO KhachHang(MaKH, TenKH, GioiTinh, DiaChi, DienThoai)" +
                    "VALUES(@MaKH, @TenKH, @GioiTinh, @DiaChi, @DienThoai)", con);
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand(
                    "UPDATE KhachHang SET TenKH = @TenKH, GioiTinh = @GioiTinh, DiaChi = @DiaChi, DienThoai = @DienThoai WHERE MaKH = @MaKH", con);
        ...
        private void btnTimKiem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("SELECT * FROM tblKhachHang WHERE TenKH LIKE @TenKH", con);
                cmd.Parameters.AddWithValue("@TenKH", "%" + txt_hoten.Text + "%");
                SqlDataAdapter da = new SqlDataAdapter(cmd);
                dt.Clear();
                da.Fill(dt);
                ...
                ($@"SELECT GioiTinh FROM KhachHang", con);
